...
export default class Login {
  ...
  handleSubmitAdmin = e => {
    ...
    const user = {
      type: "Admin",
      email: e.target.querySelector(`input[data-testid="admin-email-input"]`).value, // BugFixé
      password: e.target.querySelector(`input[data-testid="admin-password-input"]`).value, // BugFixé
      status: "connected"
    }
    this.localStorage.setItem("user", JSON.stringify(user))
    this.login(user)
